...
## Careers   
  * '05 ~ '19.02,  Koreanair R&D Center, UAV Control Law Engineer    
    * Flight control system development for unmanned MD500 helicopter (MD500 Control Law)
    * Technology development project to demonstrate the operation of 200kg class tilt-rotor UAV
    * Division reconnaissance UAV system development (RQ-102K Control Law)     
    * Low-observable scaled air vehicle development (UCAV S&C Analysis) 
    * Corps UAV integrated simulator development (RQ-101 Simulator Control Law Software)
    * Close-range UAV technology development (KUS-9 Flight Control Software) 
    * Close-range UAV technology development (KUS-7 Flight Control System)
